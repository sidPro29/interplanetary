package com.notifiy.interplanetary.data.remote
...
interface ApiService {
    ...
    suspend fun getVideos(): com.notifiy.interplanetary.data.model.AssetResponse

    @GET("custom-streamit/v1/movies")
    suspend fun getMovies(): com.notifiy.interplanetary.data.model.AssetResponse

    @GET("custom-streamit/v1/tvshows")
    suspend fun getTVShows(): com.notifiy.interplanetary.data.model.AssetResponse


    @retrofit2.http.POST("jwt-auth/v1/token")
    suspend fun login(
        @retrofit2.http.Body request: com.notifiy.interplanetary.data.model.LoginRequest
    ): com.notifiy.interplanetary.data.model.LoginResponse

    @retrofit2.http.POST("wp/v2/users")
    suspend fun signup(
        @retrofit2.http.Body request: com.notifiy.interplanetary.data.model.WpSignupRequest
    ): retrofit2.Response<okhttp3.ResponseBody>

    @retrofit2.http.GET("wp/v2/users/me")
    suspend fun getMe(
        @retrofit2.http.Header("Authorization") authHeader: String
    ): com.notifiy.interplanetary.data.model.WpUserResponse
    ...
    suspend fun getMembershipLevels(
        @retrofit2.http.Header("Authorization") authHeader: String
    ): retrofit2.Response<Map<String, com.notifiy.interplanetary.data.model.MembershipLevel>>
    ...
    ): com.notifiy.interplanetary.data.model.PaymentIntentResponse
}
