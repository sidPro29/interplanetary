...
interface ApiService {
    ...
    @POST("auth/login")
    suspend fun login(
        @Body request: com.notifiy.interplanetary.data.model.LoginRequest
    ): com.notifiy.interplanetary.data.model.LoginResponse

    @POST("auth/signup")
    suspend fun signup(
        @Body request: com.notifiy.interplanetary.data.model.WpSignupRequest
    ): Response<ResponseBody>

    @GET("users/me")
    suspend fun getMe(): com.notifiy.interplanetary.data.model.WpUserResponse
