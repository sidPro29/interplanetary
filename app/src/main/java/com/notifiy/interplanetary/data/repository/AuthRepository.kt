...
class AuthRepository @Inject constructor(
    ...
    suspend fun signup(name: String, email: String, password: String): Result<Boolean> {
        ...
        return try {
            ...
            val adminLoginRes = try {
                apiService.login(com.notifiy.interplanetary.data.model.LoginRequest(com.notifiy.interplanetary.BuildConfig.WP_ADMIN_USER, com.notifiy.interplanetary.BuildConfig.WP_ADMIN_PASSWORD))
            } catch (e: Exception) {
                null
            }
    ...
    suspend fun cancelMembership(wpUserId: Long): Boolean {
        return try {
            val adminLoginRes = apiService.login(com.notifiy.interplanetary.data.model.LoginRequest(com.notifiy.interplanetary.BuildConfig.WP_ADMIN_USER, com.notifiy.interplanetary.BuildConfig.WP_ADMIN_PASSWORD))
